...
- # Atajos de teclado
  collapsed:: true
  - **Atrás / adelante:** CTRL + ` / +
  - **Cerrar paneles:** tl / tr
  - **Grafo general:** gg
  - **Ir a Journal:** gj
  - **Ir al día presente:** gt gp (va a Tomorrow y después para detrás un día)
  - **Ir al día siguiente:** gn
  - **Ir al día anterior:** gp
  - **Ir a mañana:** gt
  - **Ir a lista de grafos:** gG (es la forma más rápida, junto al desplegable, de pasar de un grafo a otro)
  - **Abrir nueva ventana:** SHIFT + CTRL + n
...
- # Sync
  collapsed:: true
  - Parece ser que funciona bastante bien.
  - Continuar manteniendo el Git, que sigue siendo la **source of truth**.
  - Se puede sincronizar directamente sobre un directorio local del Git del mismo grafo y funciona perfectamente, el Git ni se entera.